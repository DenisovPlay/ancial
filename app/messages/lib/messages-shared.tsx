...
export const FALLBACK_AVATAR = '/img/placeholders/user.png';
export const FALLBACK_WELCOME_IMAGE = '/img/load-placeholders/chats.png';
export const NOTHING_FOUND_IMAGE = '/img/load-placeholders/nothingfound.webp';
