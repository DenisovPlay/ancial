...
export function PulsePlayerMini({
  ...
  return (
    ...
    >
      <div
        id="NAVPmini"
        className="pulse-player-mini-shell relative flex w-full touch-none items-center gap-1 overflow-hidden rounded-full border border-zinc-600/30 bg-zinc-900/20 p-1 shadow backdrop-blur-md backdrop-saturate-200 duration-300"
      ...
      >
        ...
        {hasSwipe && prevArtwork ? (
          <div
            ...
            style={prevPeekStyle}
          >
            <span className="relative block h-14 w-14 overflow-hidden rounded-full bg-zinc-800 shadow">
