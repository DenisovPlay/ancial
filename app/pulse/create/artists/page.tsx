...
export default function PulseCreateArtistsPage() {
  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <Modal isOpen={deleteModalOpen} onClose={() => setDeleteModalOpen(false)} title="Удалить артиста?">
        <div className="flex flex-col gap-4 text-center">
          <span className="text-sm text-zinc-400">
            Удаление профиля артиста необратимо удалит его с серверов Ancial Pulse. Привязанные треки и альбомы останутся.
          </span>
