    ...
    <div className="sticky top-0 flex w-full max-w-screen-2xl justify-between items-center gap-3 bg-gradient-to-b from-black via-black/90 to-transparent px-3 pt-3 lg:px-0" style={{ zIndex: 1300 }}>
      ...
      {isAuthenticated ? (
        <button
          ...
          className={cn(
            "h-12 w-12 shrink-0 cursor-pointer items-center justify-center rounded-full border border-zinc-600/30 bg-zinc-900/20 backdrop-blur-md backdrop-saturate-200 duration-300 hover:bg-zinc-700 active:scale-95",
