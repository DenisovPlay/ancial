      ...
      <div className="bg-zinc-900/20 border border-zinc-600/30 backdrop-blur-md backdrop-saturate-200 rounded-3xl w-full max-w-screen-md p-3 flex items-center gap-3 shadow -mb-10">
        <div className="flex flex-col w-full">
          ...
          <span className="text-sm lg:text-base text-zinc-300">
            Мы вас ждали, но «ремонт» ещё продолжается.
          </span>
          <span className="text-xs lg:text-sm text-zinc-400">
            Тут есть Лента, Чаты, Звонки, Музыка, Игры и Кошелёк, а ещё — множество недоработок)
          </span>
          <div className="flex items-center justify-end gap-3 mt-1.5">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden w-fit text-center px-1 py-0.5 bg-purple-500 hover:bg-purple-600 duration-300 cursor-pointer rounded-3xl border border-zinc-600/30 active:scale-95"
            >
              Оценить
            </a>
          </div>
