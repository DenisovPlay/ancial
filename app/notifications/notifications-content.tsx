  ...
  return (
    <div className="flex flex-col justify-center items-center gap-3 py-3 w-full">
      ...
      <div className="flex items-center gap-3 w-full max-w-3xl sticky top-0 bg-gradient-to-b from-black via-black/90 to-transparent p-3 lg:px-0 -my-3" style={{ zIndex: 90 }}>    
        <button 
          onClick={clearNotif}
          className="glass-panel [--glass-alpha:0.2] [--glass-sat:2] border border-zinc-600/30 hover:[--glass-tint:var(--color-zinc-700)] hover:[--glass-alpha:1] h-12 active:scale-95 px-4 py-2 duration-300 cursor-pointer shadow flex-grow rounded-full text-zinc-100" 
        >
          {lang?.clear || 'Очистить'}
        </button>
        <Link 
