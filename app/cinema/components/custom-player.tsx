        ...
        >
          ...
          {onSelectEpisodeModal && (
            <button
              ...
              className="glass-panel [--glass-tint:var(--color-white)] [--glass-alpha:0.1] focusable-tv pointer-events-auto px-4 py-2 flex items-center gap-2 rounded-full hover:[--glass-tint:var(--color-white)] hover:[--glass-alpha:0.2] border border-white/20 text-white font-bold text-xs shadow-xl outline-none focus:outline-none focus:ring-4 focus:ring-white cursor-pointer active:scale-95"
            >
            ...
            <div className="flex items-center justify-between gap-3 pt-1">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="glass-panel [--glass-tint:var(--color-white)] [--glass-alpha:0.1] focusable-tv p-2.5 rounded-full hover:[--glass-tint:var(--color-white)] hover:[--glass-alpha:0.2] text-white border border-white/10 transition-all active:scale-95 cursor-pointer outline-none focus:outline-none focus:ring-2 focus:ring-white"
                >
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1 pr-2">
          <button
            ...
            tabIndex={0}
            data-tv-player-control="back"
            className="glass-panel [--glass-alpha:0.8] focusable-tv p-2.5 rounded-3xl hover:[--glass-tint:var(--color-zinc-800)] hover:[--glass-alpha:1] border border-white/20 text-white transition-all active:scale-95 cursor-pointer outline-none focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 shadow-xl shrink-0"
          >
            <Icon name="IC-chevron-left-stroke" className="w-5 h-5 stroke-white fill-none stroke-[2.5]" />
          </button>
        ...
        {onSelectEpisodeModal && (
          <button
            ...
            className="glass-panel [--glass-tint:var(--color-white)] [--glass-alpha:0.1] focusable-tv px-3 py-2 sm:px-4 sm:py-2 flex items-center gap-1.5 sm:gap-2 rounded-3xl hover:[--glass-tint:var(--color-white)] hover:[--glass-alpha:0.2] border border-white/20 text-white font-bold text-xs shadow-xl outline-none focus:outline-none focus:ring-4 focus:ring-white cursor-pointer active:scale-95 shrink-0"
          >
      ...
      {!isPlaying && (
        <div
          onClick={togglePlay}
          className="glass-panel [--glass-tint:var(--color-black)] [--glass-alpha:0.3] [--glass-blur:4px] absolute inset-0 flex items-center justify-center cursor-pointer z-30"
        >
        ...
        <div className="flex items-center justify-between gap-3 pt-1">
          ...
          <div className="flex items-center gap-3">
            ...
            {qualities && qualities.length > 0 && (
              <div className="relative">
                <button
                  ...
                  className="glass-panel [--glass-tint:var(--color-white)] [--glass-alpha:0.1] focusable-tv px-3.5 py-2 rounded-3xl hover:[--glass-tint:var(--color-white)] hover:[--glass-alpha:0.2] border border-white/20 text-white font-bold text-xs flex items-center gap-1.5 transition-all duration-300 active:scale-95 cursor-pointer outline-none focus:outline-none focus:ring-2 focus:ring-white shadow-lg"
                >
                ...
                {showQualityDropdown && (
                  <div data-quality-dropdown="true" className="glass-panel [--glass-alpha:0.95] [--glass-blur:24px] absolute bottom-12 right-0 border border-zinc-700/60 rounded-3xl p-2 shadow-2xl z-50 flex flex-col gap-1 min-w-[130px] animate-in fade-in zoom-in-95 duration-150">
            ...
            <button
              ...
              className="glass-panel [--glass-tint:var(--color-white)] [--glass-alpha:0.1] focusable-tv p-3 rounded-3xl hover:[--glass-tint:var(--color-white)] hover:[--glass-alpha:0.2] border border-white/10 text-white transition-all duration-300 active:scale-95 cursor-pointer outline-none focus:outline-none focus:ring-2 focus:ring-white shadow-lg shrink-0 flex items-center justify-center"
            >
