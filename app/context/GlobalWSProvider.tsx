...
function NetStatusBanner() {
  ...
  return (
    <div
      className={`fixed top-0 inset-x-0 w-full flex items-center justify-center pt-1 z-[9999999999] pointer-events-none transition-transform duration-[320ms] ease-[cubic-bezier(0.34,1.4,0.64,1)] ${
