...
export default function SecuritySettingsPage() {
  ...
  return (
    <>
      <div className="flex flex-col jusitify-center items-center gap-3 pb-3 w-full bg-gradient-to-b from-blue-400/25 md:from-transparent via-transparent to-transparent">
