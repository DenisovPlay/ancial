...
export default function SocialsContent() {
  ...
  useEffect(() => {
    if (!authLoading && isAuthenticated && user && !user.connected_telegram) {
  ...
  }, [authLoading, isAuthenticated, user?.connected_telegram, tgWidgetKey]);

  // Load Yandex Suggest Script
  useEffect(() => {
    let active = true;
    if (!authLoading && isAuthenticated && user && !user.connected_yacc) {
  ...
  }, [authLoading, isAuthenticated, user?.connected_yacc, lang, checkAuth, showNote]);
          ...
          <div className="flex flex-col w-full h-full items-center justify-center gap-2 mt-3 flex-grow">
            {!user.connected_telegram ? (
              <>
                ...
                <div id="telegram-widget-container" className="flex justify-center items-center min-h-[40px]" />
              </>
            ) : (
              <>
          ...
          <div className="flex flex-col w-full items-center justify-center gap-2 mt-3 flex-grow">
            {!user.connected_yacc ? (
              <>
                ...
                <div className="rounded-full h-9 overflow-hidden w-full flex items-center justify-center mt-2 relative min-h-[36px]" id="yandexbutton">
                  {yandexLoading && (
                    <div id="SPloader" className="w-full flex items-center justify-center">
