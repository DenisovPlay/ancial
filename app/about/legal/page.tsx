...
export default function LegalPage() {
  ...
  return (
	...
	<div className="w-full max-w-4xl flex sm:items-center flex-col sm:flex-row">
		<span onClick={() => router.push("/about")} className="w-fit text-3xl font-extralight hover:text-zinc-300 duration-300 active:scale-95 flex items-center gap-1.5 px-3 lg:px-0 cursor-pointer">
		...
		<div className="shrink-0 w-fit rounded-3xl bg-zinc-900/95 border border-zinc-600/30 duration-300 flex divide-zinc-800 divide-x mx-3 mt-3 sm:mt-0 sm:mx-0">
			<button id="allbutton" onClick={() => setLangFilter("ALL")} className={`aspect-square p-2 lg:text-lg rounded-3xl duration-300 rounded-r-none flex items-center justify-center active:scale-95 cursor-pointer ${langFilter === "ALL" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:bg-zinc-800/50 hover:text-zinc-200"}`}>
				<svg className={`w-6 h-6 inline duration-300 ${langFilter === "ALL" ? "fill-white" : "fill-zinc-400"}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
					<use href={`/icons.svg#IC-globe`}></use>
				</svg>
			</button>
			<button id="rubutton" onClick={() => setLangFilter("RU")} className={`p-2 px-4 lg:text-lg duration-300 active:scale-95 cursor-pointer ${langFilter === "RU" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:bg-zinc-800/50 hover:text-zinc-200"}`}>Русский</button>
			<button id="enbutton" onClick={() => setLangFilter("EN")} className={`p-2 px-4 lg:text-lg rounded-3xl duration-300 rounded-l-none active:scale-95 cursor-pointer ${langFilter === "EN" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:bg-zinc-800/50 hover:text-zinc-200"}`}>English</button>
		</div>
	</div>
	...
	<div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 px-3 lg:px-0 duration-300 transition-all">
		<div onClick={() => setActiveModal("bezopasnost")} className={`RU  relative bg-zinc-900 rounded-3xl shadow p-3 lg:p-6 gap-3 flex flex-col items-center justify-center duration-300 hover:bg-zinc-800/70 cursor-pointer active:scale-95 border border-zinc-600/30 ${isVisible("RU") ? "flex" : "hidden"}`}>
			<span className="text-sm px-2 py-1 font-medium bg-purple-500/50 rounded-3xl rounded-bl-none rounded-tr-none absolute top-0 left-0 text-default duration-300 shadow">Русский</span>
			<svg className="w-16 h-16 fill-purple-500 hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
			...
			<svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16" viewBox="0,0,256,256">
				<defs>
					<linearGradient x1="16.09" y1="13.794" x2="29.568" y2="27.272" gradientUnits="userSpaceOnUse" id="color-1_Vq0a3AGLLhJ6_gr1">
						<stop offset="0" stopColor="#7259ff" stopOpacity="0.95"></stop>
						<stop offset="1" stopColor="#7259ff" stopOpacity="0.5"></stop>
					</linearGradient>
					<linearGradient x1="23.146" y1="26.146" x2="24.854" y2="27.854" gradientUnits="userSpaceOnUse" id="color-2_Vq0a3AGLLhJ6_gr2">
						...
						<stop offset="0.519" stopColor="#ffffff" stopOpacity="0.5"></stop>
						<stop offset="1" stopColor="#ffffff" stopOpacity="0.6"></stop>
					</linearGradient>
					...
					<linearGradient x1="6.566" y1="7.859" x2="25.362" y2="26.655" gradientUnits="userSpaceOnUse" id="color-10_Vq0a3AGLLhJ6_gr10">
						<stop offset="0" stopColor="#2680ff" stopOpacity="0.95"></stop>
						<stop offset="1" stopColor="#2680ff" stopOpacity="0.5"></stop>
					</linearGradient>
					...
					<linearGradient x1="5.439" y1="9.146" x2="26.561" y2="30.268" gradientUnits="userSpaceOnUse" id="color-23_Vq0a3AGLLhJ6_gr23">
						<stop offset="0" stopColor="#ffffff" stopOpacity="0.6"></stop>
						<stop offset="0.493" stopColor="#ffffff" stopOpacity="0"></stop>
						<stop offset="0.997" stopColor="#ffffff" stopOpacity="0.3"></stop>
					</linearGradient>
				</defs>
				<g fillOpacity="0" fill="#dddddd" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" style={{mixBlendMode: "normal"}}>
			...
			<span className="text-zinc-200 text-center">Политика обработки персональных данных</span>
		</div>
		<div onClick={() => setActiveModal("rules-ru")} className={`RU  relative bg-zinc-900 rounded-3xl shadow p-3 lg:p-6 gap-3 flex flex-col items-center justify-center duration-300 hover:bg-zinc-800/70 cursor-pointer active:scale-95 border border-zinc-600/30 ${isVisible("RU") ? "flex" : "hidden"}`}>
			<span className="text-sm px-2 py-1 font-medium bg-purple-500/50 rounded-3xl rounded-bl-none rounded-tr-none absolute top-0 left-0 text-default duration-300 shadow">Русский</span>
			<svg className="w-16 h-16 fill-purple-500 hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
				<path d="M 12.5 4 C 10.032499 4 8 6.0324991 8 8.5 L 8 39.5 C 8 41.967501 10.032499 44 12.5 44 L 35.5 44 C 37.967501 44 40 41.967501 40 39.5 L 40 18.5 A 1.50015 1.50015 0 0 0 39.560547 17.439453 L 39.544922 17.423828 L 26.560547 4.4394531 A 1.50015 1.50015 0 0 0 25.5 4 L 12.5 4 z M 12.5 7 L 24 7 L 24 15.5 C 24 17.967501 26.032499 20 28.5 20 L 37 20 L 37 39.5 C 37 40.346499 36.346499 41 35.5 41 L 12.5 41 C 11.653501 41 11 40.346499 11 39.5 L 11 8.5 C 11 7.6535009 11.653501 7 12.5 7 z M 27 9.1210938 L 34.878906 17 L 28.5 17 C 27.653501 17 27 16.346499 27 15.5 L 27 9.1210938 z M 17.5 25 A 1.50015 1.50015 0 1 0 17.5 28 L 30.5 28 A 1.50015 1.50015 0 1 0 30.5 25 L 17.5 25 z M 17.5 32 A 1.50015 1.50015 0 1 0 17.5 35 L 26.5 35 A 1.50015 1.50015 0 1 0 26.5 32 L 17.5 32 z"></path>
			</svg>
			<svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16" viewBox="0 0 32 32">
				<linearGradient id="RGNWhQdzV6900AW9WSy0xa_IO7KMhAWvLJO_gr1" x1="4.892" x2="27.108" y1="5.284" y2="27.5" gradientUnits="userSpaceOnUse">
					<stop offset="0" stopColor="#00e9ff" stopOpacity=".95"></stop>
					<stop offset="1" stopColor="#00e9ff" stopOpacity=".5"></stop>
				</linearGradient>
				...
				<linearGradient id="RGNWhQdzV6900AW9WSy0xb_IO7KMhAWvLJO_gr2" x1="4.892" x2="27.108" y1="5.284" y2="27.5" gradientUnits="userSpaceOnUse">
					...
					<stop offset=".493" stopColor="#fff" stopOpacity="0"></stop>
					<stop offset=".997" stopColor="#fff" stopOpacity=".3"></stop>
				</linearGradient>
				...
				<linearGradient id="RGNWhQdzV6900AW9WSy0xc_IO7KMhAWvLJO_gr3" x1="11.793" x2="16.207" y1="5.793" y2="10.207" gradientUnits="userSpaceOnUse">
					...
					<stop offset=".519" stopColor="#fff" stopOpacity=".5"></stop>
					<stop offset="1" stopColor="#fff" stopOpacity=".6"></stop>
				</linearGradient>
		...
		<div onClick={() => setActiveModal("rules-pulse-ru")} className={`RU  relative bg-zinc-900 rounded-3xl shadow p-3 lg:p-6 gap-3 flex flex-col items-center justify-center duration-300 hover:bg-zinc-800/70 cursor-pointer active:scale-95 border border-zinc-600/30 ${isVisible("RU") ? "flex" : "hidden"}`}>
			<span className="text-sm px-2 py-1 font-medium bg-purple-500/50 rounded-3xl rounded-bl-none rounded-tr-none absolute top-0 left-0 text-default duration-300 shadow">Русский</span>
			<svg className="w-16 h-16 fill-purple-500 hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
				<path d="M 12.5 4 C 10.032499 4 8 6.0324991 8 8.5 L 8 39.5 C 8 41.967501 10.032499 44 12.5 44 L 35.5 44 C 37.967501 44 40 41.967501 40 39.5 L 40 18.5 A 1.50015 1.50015 0 0 0 39.560547 17.439453 L 39.544922 17.423828 L 26.560547 4.4394531 A 1.50015 1.50015 0 0 0 25.5 4 L 12.5 4 z M 12.5 7 L 24 7 L 24 15.5 C 24 17.967501 26.032499 20 28.5 20 L 37 20 L 37 39.5 C 37 40.346499 36.346499 41 35.5 41 L 12.5 41 C 11.653501 41 11 40.346499 11 39.5 L 11 8.5 C 11 7.6535009 11.653501 7 12.5 7 z M 27 9.1210938 L 34.878906 17 L 28.5 17 C 27.653501 17 27 16.346499 27 15.5 L 27 9.1210938 z M 17.5 25 A 1.50015 1.50015 0 1 0 17.5 28 L 30.5 28 A 1.50015 1.50015 0 1 0 30.5 25 L 17.5 25 z M 17.5 32 A 1.50015 1.50015 0 1 0 17.5 35 L 26.5 35 A 1.50015 1.50015 0 1 0 26.5 32 L 17.5 32 z"></path>
			</svg>
			...
			<span className="text-zinc-200 text-center">Правила публикации на Pulse</span>
		</div>
		<div onClick={() => setActiveModal("rules-en")} className={`EN  relative bg-zinc-900 rounded-3xl shadow p-3 lg:p-6 gap-3 flex flex-col items-center justify-center duration-300 hover:bg-zinc-800/70 cursor-pointer active:scale-95 border border-zinc-600/30 ${isVisible("EN") ? "flex" : "hidden"}`}>
			<span className="text-sm px-2 py-1 font-medium bg-amber-500/50 rounded-3xl rounded-bl-none rounded-tr-none absolute top-0 left-0 text-default duration-300 shadow">English</span>
			<svg className="w-16 h-16 fill-purple-500 hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
				<path d="M 12.5 4 C 10.032499 4 8 6.0324991 8 8.5 L 8 39.5 C 8 41.967501 10.032499 44 12.5 44 L 35.5 44 C 37.967501 44 40 41.967501 40 39.5 L 40 18.5 A 1.50015 1.50015 0 0 0 39.560547 17.439453 L 39.544922 17.423828 L 26.560547 4.4394531 A 1.50015 1.50015 0 0 0 25.5 4 L 12.5 4 z M 12.5 7 L 24 7 L 24 15.5 C 24 17.967501 26.032499 20 28.5 20 L 37 20 L 37 39.5 C 37 40.346499 36.346499 41 35.5 41 L 12.5 41 C 11.653501 41 11 40.346499 11 39.5 L 11 8.5 C 11 7.6535009 11.653501 7 12.5 7 z M 27 9.1210938 L 34.878906 17 L 28.5 17 C 27.653501 17 27 16.346499 27 15.5 L 27 9.1210938 z M 17.5 25 A 1.50015 1.50015 0 1 0 17.5 28 L 30.5 28 A 1.50015 1.50015 0 1 0 30.5 25 L 17.5 25 z M 17.5 32 A 1.50015 1.50015 0 1 0 17.5 35 L 26.5 35 A 1.50015 1.50015 0 1 0 26.5 32 L 17.5 32 z"></path>
			</svg>
			<svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16" viewBox="0 0 32 32">
		...
		<div onClick={() => setActiveModal("cookie")} className={`RU  relative bg-zinc-900 rounded-3xl shadow p-3 lg:p-6 gap-3 flex flex-col items-center justify-center duration-300 hover:bg-zinc-800/70 cursor-pointer active:scale-95 border border-zinc-600/30 ${isVisible("RU") ? "flex" : "hidden"}`}>
			<span className="text-sm px-2 py-1 font-medium bg-purple-500/50 rounded-3xl rounded-bl-none rounded-tr-none absolute top-0 left-0 text-default duration-300 shadow">Русский</span>
			<svg className="w-16 h-16 fill-purple-500 hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
				<path d="M 12.5 4 C 10.032499 4 8 6.0324991 8 8.5 L 8 39.5 C 8 41.967501 10.032499 44 12.5 44 L 35.5 44 C 37.967501 44 40 41.967501 40 39.5 L 40 18.5 A 1.50015 1.50015 0 0 0 39.560547 17.439453 L 39.544922 17.423828 L 26.560547 4.4394531 A 1.50015 1.50015 0 0 0 25.5 4 L 12.5 4 z M 12.5 7 L 24 7 L 24 15.5 C 24 17.967501 26.032499 20 28.5 20 L 37 20 L 37 39.5 C 37 40.346499 36.346499 41 35.5 41 L 12.5 41 C 11.653501 41 11 40.346499 11 39.5 L 11 8.5 C 11 7.6535009 11.653501 7 12.5 7 z M 27 9.1210938 L 34.878906 17 L 28.5 17 C 27.653501 17 27 16.346499 27 15.5 L 27 9.1210938 z M 17.5 25 A 1.50015 1.50015 0 1 0 17.5 28 L 30.5 28 A 1.50015 1.50015 0 1 0 30.5 25 L 17.5 25 z M 17.5 32 A 1.50015 1.50015 0 1 0 17.5 35 L 26.5 35 A 1.50015 1.50015 0 1 0 26.5 32 L 17.5 32 z"></path>
			</svg>
			...
			<span className="text-zinc-200 text-center">Политика использования файлов Cookie</span>
		</div>
	</div>
	<div className="lg:hidden"><br /><br /><br /><br /></div>
</div>

      <Modal width="lg" isOpen={activeModal === "rules-pulse-ru"} onClose={() => setActiveModal(null)} title="Правила Pulse" swipeable={true}>
        <div className="bg-zinc-900 text-zinc-100 rounded-3xl p-3" id="rules-pulse-ru">
          <div className="container mx-auto py-12 prose prose-invert max-w-4xl">
            ...
            <header className="mb-12 text-center">
              ...
              <p className="mt-2">
                <a href="https://ancial.ru/legal" className="text-purple-400 hover:text-purple-300 underline">
              ...
              <div className="mt-6 p-4 bg-zinc-900 rounded-3xl border border-zinc-800">
                <p className="text-sm">
                  ...
                  <a href="mailto:contact@ancial.ru?subject=[Копирайт]" className="text-purple-400 hover:text-purple-300">[Копирайт]</a> | 
                  <a href="mailto:contact@ancial.ru?subject=[Пропаганда]" className="text-purple-400 hover:text-purple-300">[Пропаганда]</a>
                  <br />
                  <span className="text-red-400">❗ Блокируем в течение 24 часов по обоснованному требованию (ст. 15.1 149-ФЗ)</span>
                </p>
              </div>
            </header>
            {/*  NAVIGATION  */}
            <nav className="mb-12 bg-black/80 backdrop-blur-sm p-4 rounded-3xl border border-zinc-800">
              <h2 className="text-xl font-semibold text-purple-500 mb-3">Содержание</h2>
            ...
            <section id="section-1" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">1. Общие положения (информационный посредник)</h2>
              <ol className="list-decimal list-inside space-y-4">
                ...
                <li>
                  Используя Pulse, вы принимаете настоящие <a href="https://ancial.ru/legal" className="text-purple-400 hover:text-purple-300">Правила</a> и 
                  <a href="https://ancial.ru/legal" className="text-purple-400 hover:text-purple-300">Политику конфиденциальности</a>.
                </li>
              </ol>
            </section>
            {/*  SECTION 2  */}
            <section id="section-2" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">2. Загрузка контента (ваши обязанности)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            <section id="section-3" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-red-500 pl-4 mb-4">3. Запрещённый контент</h2>
              <div className="bg-red-900/30 border border-red-800 p-6 rounded-3xl mb-6">
                <p className="text-red-200 font-semibold mb-4">❌ СТРОГО ЗАПРЕЩЕНО загружать:</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-red-100">
                  <ul className="list-disc ml-6 space-y-1">
                    ...
                    <li>Пропаганда/упоминания наркотиков <br /> <span className="text-red-300">(даже негативные без маркировки "опасно и незаконно")</span></li>
                    <li>Порнография, эротика, ЛГБТ-пропаганда <br /> <span className="text-red-300">(«Деятельность „Международного общественного движения ЛГБТ“ запрещена в Российской Федерации»)</span></li>
            ...
            <section id="section-4" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">4. Авторские права и жалобы</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
                  Правообладатели направляют уведомления на 
                  <a href="mailto:contact@ancial.ru?subject=[Копирайт]" className="text-purple-400">[Копирайт]</a>:
                ...
                <li>
                  Контр-уведомление: <a href="mailto:contact@ancial.ru?subject=[Апелляция]" className="text-purple-400">[Апелляция]</a>.
                </li>
                <li>
            ...
            <section id="section-5" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-red-500 pl-4 mb-4">5. Политические ограничения</h2>
              <div className="bg-red-900/30 border border-red-800 p-6 rounded-3xl mb-6">
                <p className="text-red-300 font-semibold mb-4">🚫 Запрещено публиковать материалы:</p>
            ...
            <section id="section-6" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">6. Модерация и санкции</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
                ...
                <li>
                  Апелляция: <a href="mailto:contact@ancial.ru?subject=[Апелляция]" className="text-purple-400">[Апелляция]</a> (5 дней).
                </li>
              </ol>
            </section>
            <section id="section-8" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-red-500 pl-4 mb-4">7. Запрещённые исполнители в Pulse</h2>
              <p className="mb-4">
                ...
                <a href="mailto:contact@ancial.ru?subject=[Запрещённый исполнитель]" className="text-purple-400">contact@ancial.ru</a>
                ...
                <table className="w-full text-sm text-zinc-300 border-collapse">
                  <thead>
                    <tr className="bg-gradient-to-r from-red-900/50 to-red-800/50 border-b border-red-600/50">
                      <th className="p-3 text-left font-semibold text-red-200 border-r border-red-500/30">Исполнитель</th>
                      <th className="p-3 text-left font-semibold text-red-200 border-r border-red-500/30">Причина</th>
                      <th className="p-3 text-left font-semibold text-red-200 w-48">Статус</th>
                    </tr>
                  </thead>
                  <tbody>
                    {/*  Российские  */}
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Земфира (Рамазанова)</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Сборы для ВСУ, иноагент Минюста РФ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Рената Литвинова</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Сборы для ВСУ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Артём Смольянинов</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Сборы для ВСУ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Юрий Шевчук (ДДТ)</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Сборы для ВСУ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Максим Покровский ("Ногу свело!")</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Сборы для ВСУ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Татьяна Лазарева</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Сборы для ВСУ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Алексей Кортнев</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Публичная поддержка Украины против РФ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Моргенштерн</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Иноагент Минюста РФ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Oxxxymiron</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">"Антивоенные"/Проукраинские концерты, поддержка Украины, иноагент Минюста РФ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Монеточка / NoizeMC</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">"Антивоенные"/Проукраинские концерты, поддержка Украины, иноагент Минюста РФ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    {/*  Украинские  */}
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Андрей Хлывнюк ("Бумбокс")</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Служит в ВСУ, оператор БПЛА</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="border-b border-zinc-700/50 hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Макс Барских</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Вступил в ВСУ, запретил музыку в РФ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                    <tr className="hover:bg-zinc-800/50 transition-all duration-200">
                      <td className="p-3 font-medium text-zinc-200 border-r border-zinc-600/50">Потап</td>
                      <td className="p-3 text-amber-300 border-r border-zinc-600/50">Донаты ВСУ</td>
                      <td className="p-3"><span className="bg-red-900/50 text-red-200 px-2 py-1 rounded-full text-xs font-bold">Публикация запрещена</span></td>
                    </tr>
                  </tbody>
                </table>
            ...
            <section id="section-7" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-amber-500 pl-4 mb-4">8. Контакты для властей и пользователей</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-amber-900/30 border border-amber-800 p-4 rounded-3xl">
                  <h3 className="font-semibold text-amber-300 mb-2">[Копирайт]</h3>
                  <a href="mailto:contact@ancial.ru?subject=[Копирайт]" className="text-amber-200">[Копирайт]</a>
                  <p className="text-amber-400 text-sm mt-1">Авторские права, DMCA</p>
                </div>
                <div className="bg-amber-900/30 border border-amber-800 p-4 rounded-3xl">
                  <h3 className="font-semibold text-amber-300 mb-2">[Пропаганда]</h3>
                  <a href="mailto:contact@ancial.ru?subject=[Пропаганда]" className="text-amber-200">[Пропаганда]</a>
                  <p className="text-amber-400 text-sm mt-1">Наркотики, экстремизм, политика</p>
                </div>
                <div className="bg-amber-900/30 border border-amber-800 p-4 rounded-3xl">
                  <h3 className="font-semibold text-amber-300 mb-2">[Жалоба]</h3>
                  <a href="mailto:contact@ancial.ru?subject=[Жалоба]" className="text-amber-200">[Жалоба]</a>
                  <p className="text-amber-400 text-sm mt-1">Общие нарушения</p>
                </div>
                <div className="bg-amber-900/30 border border-amber-800 p-4 rounded-3xl">
                  <h3 className="font-semibold text-amber-300 mb-2">[Апелляция]</h3>
                  <a href="mailto:contact@ancial.ru?subject=[Апелляция]" className="text-amber-200">[Апелляция]</a>
                  <p className="text-amber-400 text-sm mt-1">Оспорить блокировку</p>
                </div>
              </div>
            <div className="mt-8 p-6 bg-zinc-900 rounded-3xl border border-zinc-700">
              <p className="text-sm">
                Полная версия правил: 
                <a href="https://ancial.ru/legal" className="text-purple-400 hover:text-purple-300 underline font-medium">ancial.ru/legal</a>
              </p>
            </div>
            </section>
            {/*  FOOTER  */}
      ...
      <Modal width="lg" isOpen={activeModal === "rules-ru"} onClose={() => setActiveModal(null)} title="Правила" swipeable={true}>
        <div className="bg-zinc-900 text-zinc-100 rounded-3xl p-3" id="rules-ru">
          <div className="container mx-auto py-12 prose prose-invert max-w-4xl">
            {/*  HEADER  */}
            <header className="mb-12 text-center">
              <p className="text-zinc-400 text-lg">
              ...
              <div className="mt-6 p-4 bg-zinc-900 rounded-3xl border border-zinc-800">
                <p className="text-sm">
                  ...
                  <a href="mailto:contact@ancial.ru" className="text-purple-400 hover:text-purple-300">contact@ancial.ru</a>
                  <br />
                  <span className="text-red-400">❗ Обязательно указывайте тему письма в формате <code className="email-tag">[ТЕМА]</code></span>
                </p>
              </div>
            </header>
            {/*  NAVIGATION  */}
            ...
            {/*  SECTION 1  */}
            <section id="section-1" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">1. Общие положения</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 2  */}
            <section id="section-2" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">2. Регистрация и аккаунт</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 3  */}
            <section id="section-3" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">3. Лента (посты)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 4  */}
            <section id="section-4" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">4. Чаты (личные и групповые сообщения)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 5  */}
            <section id="section-5" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">5. Музыка (Pulse)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 6  */}
            <section id="section-6" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">6. Видео (ClickPlay/Stream)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 7  */}
            <section id="section-7" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">7. Кошелёк (Wallet) и токены anci</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 8  */}
            <section id="section-8" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">8. Авторские права и жалобы</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            <section id="section-9" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">9. Запрещённое поведение и санкции</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
                  Запрещено:
                  <div className="bg-red-900/30 border border-red-800 p-4 rounded-3xl mt-3 mb-3">
            ...
            <section id="section-10" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">10. Конфиденциальность и данные</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            <section id="section-11" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">11. Модерация и апелляции</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            <section id="section-12" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">12. Изменения правил и юридические аспекты</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            <section id="section-13" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">13. Сообщества и группы</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  CONCLUSION  */}
            <section id="conclusion" className="mb-16 scroll-mt-20 pt-8 border-t border-zinc-800">
              <h2 className="text-3xl font-bold text-zinc-50 mb-6">Заключение</h2>
              <p className="mb-6">
                ...
                <a href="https://ancial.ru/legal" className="text-purple-400 hover:text-purple-300 underline font-medium">https://ancial.ru/legal</a>
              </p>
              <div className="bg-zinc-900 p-6 rounded-3xl border border-purple-800/50">
                <h3 className="text-xl font-semibold text-purple-400 mb-3">❗ ВАЖНО</h3>
                <p>
                  При отправке любого письма на <strong>contact@ancial.ru</strong> обязательно указывайте тему в формате <code className="email-tag">[ТЕМА]</code>, например:
                </p>
            ...
            <footer className="text-center py-8 text-zinc-500 text-sm border-t border-zinc-800 mt-12">
              ...
              <p className="mt-2">
                Версия правил: 1.3 | Опубликовано: <a href="https://ancial.ru/legal" className="text-purple-400 hover:underline">ancial.ru/legal</a>
              </p>
            </footer>
          </div>
        </div>
      ...
      <Modal width="lg" isOpen={activeModal === "rules-en"} onClose={() => setActiveModal(null)} title="Terms of Service" swipeable={true}>
        <div className="bg-zinc-900 text-zinc-100 rounded-3xl p-3" id="rules-en">
          <div className="container mx-auto py-12 prose prose-invert max-w-4xl">
            {/*  HEADER  */}
            <header className="mb-12 text-center">
              <p className="text-zinc-400 text-lg">
              ...
              <div className="mt-6 p-4 bg-zinc-900 rounded-3xl border border-zinc-800">
                <p className="text-sm">
                  ...
                  <a href="mailto:contact@ancial.ru" className="text-purple-400 hover:text-purple-300">contact@ancial.ru</a>
                  <br />
                  <span className="text-red-400">❗ Always specify the subject of the email in the format <code className="email-tag">[SUBJECT]</code></span>
                </p>
              </div>
            </header>
            {/*  NAVIGATION  */}
            <nav className="mb-12 bg-black/80 backdrop-blur-sm p-4 rounded-3xl border border-zinc-800">
              <h2 className="text-xl font-semibold text-purple-500 mb-3">Table of Contents</h2>
              <ul className="space-y-2 text-sm">
            ...
            {/*  SECTION 1  */}
            <section id="section-1" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">1. General Provisions</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 2  */}
            <section id="section-2" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">2. Registration and Account</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 3  */}
            <section id="section-3" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">3. Feed (Posts)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 4  */}
            <section id="section-4" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">4. Chats (Private and Group Messages)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 5  */}
            <section id="section-5" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">5. Music (Pulse)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 6  */}
            <section id="section-6" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">6. Videos (ClickPlay/Stream)</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 7  */}
            <section id="section-7" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">7. Wallet and anci Tokens</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 8  */}
            <section id="section-8" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">8. Copyright and Complaints</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 9  */}
            <section id="section-9" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">9. Prohibited Behavior and Sanctions</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
                  Prohibited:
                  <div className="bg-red-900/30 border border-red-800 p-4 rounded-3xl mt-3 mb-3">
            ...
            {/*  SECTION 10  */}
            <section id="section-10" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">10. Privacy and Data</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 11  */}
            <section id="section-11" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">11. Moderation and Appeals</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 12  */}
            <section id="section-12" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">12. Changes to Terms and Legal Aspects</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  SECTION 13  */}
            <section id="section-13" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl font-bold text-zinc-50 border-l-4 border-purple-500 pl-4 mb-4">13. Communities and Groups</h2>
              <ol className="list-decimal list-inside space-y-4">
                <li>
            ...
            {/*  CONCLUSION  */}
            <section id="conclusion" className="mb-16 scroll-mt-20 pt-8 border-t border-zinc-800">
              <h2 className="text-3xl font-bold text-zinc-50 mb-6">Conclusion</h2>
              <p className="mb-6">
              ...
              <div className="bg-zinc-900 p-6 rounded-3xl border border-purple-800/50">
                <h3 className="text-xl font-semibold text-purple-400 mb-3">❗ IMPORTANT</h3>
                <p>
                  When sending any email to <strong>contact@ancial.ru</strong>, always specify the subject in the format <code className="email-tag">[SUBJECT]</code>, for example:
                </p>
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <footer className="text-center py-8 text-zinc-500 text-sm border-t border-zinc-800 mt-12">
              ...
              <p className="mt-2">
                Terms version: 1.3 | Published: <a href="https://ancial.ru/legal" className="text-purple-400 hover:underline">ancial.ru/legal</a>
              </p>
            </footer>
          </div>
                </div>
              ...
              <Modal width="lg" isOpen={activeModal === "cookie"} onClose={() => setActiveModal(null)} title="Документ" swipeable={true}>
                <div className="bg-zinc-900 text-zinc-100 rounded-3xl p-3" id="cookie">
                  
          <div className="flex">
            <span className="font-medium text-left text-zinc-200 text-lg flex-grow">Политика использования файлов Cookie</span>
            <svg data-fancybox-close className="inline duration-300  cursor-pointer w-5 h-5 fill-white inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
          ...
          <div>
            ...
            Актуальная версия настоящей Политики использования файлов cookie размещена в сети Интернет по адресу:<a href="https://ancial.ru/legal/" target="_blank" className="text-blue-500 hover:underline">https://ancial.ru/legal/</a>. Мы оставляем за собой право вносить в неё изменения в любое время без предварительного уведомления. Обновлённая редакция вступает в силу с момента её публикации по указанному адресу.</p>
          </div>
        </div>
      </Modal>


      <Modal width="lg" isOpen={activeModal === "bezopasnost"} onClose={() => setActiveModal(null)} title="Политика обработки персональных данных" swipeable={true}>
        <div className="bg-zinc-900 text-zinc-100 rounded-3xl p-3" id="bezopasnost">
          <div>
            ...
            <br />
            <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее &ndash; Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта&nbsp;<span className="text-purple-500">https://ancial.ru</span>.</p>
            <br />
            ...
            <br />
            <p>2.3. Веб-сайт &ndash; совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу&nbsp;<span className="text-purple-500">https://ancial.ru</span>.</p>
            <br />
            ...
            <br />
            <p>2.8. Персональные данные &ndash; любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта&nbsp;<span className="text-purple-500">https://ancial.ru</span>.</p>
            <br />
            <p>
            ...
            <br />
            <p>2.10. Пользователь &ndash; любой посетитель веб-сайта&nbsp;<span className="text-purple-500">https://ancial.ru</span>.</p>
            <br />
            ...
            <p>&ndash;&nbsp;предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте <span className="text-purple-500">https://ancial.ru</span>.</p>
            <br />
            <p>
              ...
              Оператору письмо на адрес электронной почты&nbsp;contact@ancial.ru&nbsp;с пометкой &laquo;Отказ от уведомлений о новых продуктах и услугах и специальных предложениях&raquo;.
            </p>
            <br />
            ...
            <br />
            <p>
              8.2. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте&nbsp;<span className="text-purple-500">https://ancial.ru</span>&nbsp;или
            ...
            <br />
            <p>
              10.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора&nbsp;<span className="text-purple-500">contact@ancial.ru</span>&nbsp;с
            ...
            <p>
              ...
              Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора&nbsp;<span className="text-purple-500">contact@ancial.ru</span>&nbsp;с
            ...
            <br />
            <p>14.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты&nbsp;<span className="text-purple-500">contact@ancial.ru</span>.</p>
            <br />
            ...
            <br />
            <p>14.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу&nbsp;<span className="text-purple-500">https://ancial.ru/legal</span>.</p>
          </div>
        </div>
      </Modal>
