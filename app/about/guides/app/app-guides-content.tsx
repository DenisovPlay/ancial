        ...
        <div className="flex flex-col jusitify-center items-center gap-3 py-3">
            ...
            <div className="flex flex-col w-full max-w-4xl pb-64">
                ...
                <div className="w-full text-lg text-zinc-200 px-3 lg:px-0 pt-3 flex flex-col">
                    ...
                    <AppImage width={927} height={380} sizes="(max-width: 420px) 100vw, 384px" src="/img/guides/app/ios1.png" alt="iOS Safari Шаг 1" loading="lazy" className="max-w-sm rounded-2xl shadow" />
                    <span>4. Выберите пункт &quot;На экран &quot;Домой&quot;.</span>
                    <AppImage width={927} height={1280} sizes="(max-width: 420px) 100vw, 384px" src="/img/guides/app/ios2.png" alt="iOS Safari Шаг 2" loading="lazy" className="max-w-sm rounded-2xl shadow" />
                ...
                <div className="w-full text-lg text-zinc-200 px-3 lg:px-0 pt-3 flex flex-col">
                    ...
                    <AppImage width={1080} height={260} sizes="(max-width: 420px) 100vw, 384px" src="/img/guides/app/android1.png" alt="Android Chrome Шаг 1" loading="lazy" className="max-w-sm rounded-2xl shadow" />
                    <span>4. Выберите пункт &quot;Добавить на гл. экран&quot;.</span>
                    <AppImage width={1080} height={1078} sizes="(max-width: 420px) 100vw, 384px" src="/img/guides/app/android2.png" alt="Android Chrome Шаг 2" loading="lazy" className="max-w-sm rounded-2xl shadow" />
